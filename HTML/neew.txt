<!-- retrieve $id  = $_SESSION['Branch_id'], set on avail.php  -->

<!DOCTYPE html>
<html>

<head>
    <!-- SELECT Branch_nm FROM `branches` WHERE Branch_ID=$id -->
...
<body>
    ...
    <div class="div2">
        <div class="row">
            ...
            <!-- SELECT Branch_add FROM `branches` WHERE Branch_ID=$id -->
        ...
        <div class="container">
            <ul class="nav nav-tabs" role="tablist">
                <!-- SELECT Pkg_des FROM `branches` INNER JOIN package WHERE Branch_ID=$id -->
                <!-- WHILE LOOP 
                <li class="nav-item">
                    <a class='nav-link active' href="standard.php" target="frame1" role='tab' id='std'><?php //echo $row['Pkg_des']; ?></a>
                </li> 
                WHILE LOOP COMPLETE-->
            </ul>
        </div>
